  ...
  <div class="contract-wrap">
    <div class="contract-content">
      <div>
        <div style="height: 1080px;">
          ...
          <p style="line-height:42pt; margin:5pt 0pt; text-align:center">
            <span style="font-family:宋体; font-size:42pt; font-weight:bold">最高额保证合同</span>
          </p>
      ...
      <div>
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt 0pt 0pt 27.75pt; orphans:0; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第一条 最高额保证定义与被保证主债权</span>
        </p>
        <p
          style="background-color:#ffffff; font-size:12pt; line-height:150%; margin:0pt; text-indent:20pt"
        >
          <span style="font-family:宋体; font-size:12pt">一、最高额保证</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >，是指债权人与保证人之间就债务人在一定期间内连续发生的多笔债务，确定一个最高额度，由保证人在此最高额度内对债务人履行债务向债权人提供保证。该最高额度是指债务人在债权人处的各项债务（含或有负债）的总余额。</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >包括但不限于全部本金、利息（包括复利和罚息）、违约金、赔偿金、债务人应向乙方支付的其他款项（包括但不限于乙方垫付的有关手续费、电讯费、杂费、信用证项下受益人拒绝承担的有关银行费用等）、乙方实现债权与担保权利而发生的费用（包括但不限于诉讼费、仲裁费、财产保全费、差旅费、执行费、评估费、拍卖费、公证费、送达费、保全担保费、公告费、律师费等）。</span>
        </p>
        <p
          style="background-color:#ffffff; font-size:12pt; line-height:150%; margin:0pt; text-indent:20pt"
        >
          <span style="font-family:宋体; font-size:12pt">二、被保证的主债权</span>
        </p>
        <p
          style="background-color:#ffffff; font-size:12pt; line-height:150%; margin:0pt; text-indent:20pt"
        >
          <span style="font-family:宋体; font-size:12pt">被保证的主债权是指自</span>
          ...
          <span style="font-family:宋体; font-size:12pt">期间因本合同乙方根据自己与债务人</span>
          <input style="width: 150px" v-model="info.a15" type="text">
          <span style="font-family:宋体; font-size:12pt">之间的综合授信合同向债务人</span>
          <input style="width: 150px" v-model="info.a16" type="text">
          <span style="font-family:宋体; font-size:12pt">授信（综合授信合同编号为</span>
          <input style="width: 200px" v-model="info.a17" type="text">
          <span style="font-family:宋体; font-size:12pt">）而形成的一系列债权，其最高本金额度为人民币</span>
          <input style="width: 100px" v-model="info.a18" type="text">
          <span style="font-family:宋体; font-size:12pt">万</span>
          <span style="font-family:宋体; font-size:12pt">元整。</span>
        </p>
        <p
          style="background-color:#ffffff; font-size:12pt; line-height:150%; margin:0pt; text-indent:20pt"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >在上述约定期限和最高额度内，债权人与债务人根据综合授信合同所签订的一系列借款合同及相关协议和其他法律文件为本合同的主合同。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >三、主合同项下的贷款、垫款、利息、费用或乙方的任何其他债权的实际形成时间即使超出债权确定期间，仍然属于本最高额保证的担保范围。主合同项下债务履行期限届满日不受债权确定期间届满日的限制。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第二条 保证方式</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">甲方在本合同项下提供的保证为连带责任保证。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第三条 保证期间</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >一、本合同项下的保证期间按乙方为债务人办理的单笔授信业务分别计算，即自单笔授信业务的主合同签订之日起至债务人在该主合同项下的债务履行期限届满日后</span>
          <span style="font-family:宋体; font-size:12pt">两年止。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >二、乙方与债务人就主合同项下债务履行期限达成展期协议的,保证期间至展期协议重新约定的债务履行期限届满之日后两年止。展期无需经保证人同意，保证人仍需承担连带保证责任。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >三、若发生法律法规规定或主合同约定的事项，乙方宣布债务提前到期的，保证期间至债务提前到期之日后两年止。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第四条 保证合同的独立性</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第五条 主合同变更</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >一、甲方同意，乙方与债务人签订主合同或对主合同进行任何变更（包括但不限于延长债务履行期限或增加债权本金金额），均无需通知甲方，甲方仍应在本合同约定的最高额以及担保范围内承担担保责任。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">二、甲方的保证责任不因出现下列任一情况而减免：</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">（一）乙方或债务人发生改制、合并、兼并、分立、增减资本、合资、联营、更名等情形；</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">（二）乙方委托第三方履行其在主合同项下的义务。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">三、主合同项下债权转让的，本合同项下的保证随之转让。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >四、主合同项下债权或债务的转移行为未生效、无效、被撤销、被解除，甲方仍按照本合同对乙方承担连带保证责任。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">第六条 保证责任</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >一、如果主合同项下债务到期或者乙方根据主合同的约定或法律规定宣布债务提前到期，债务人未按时足额履行，或者债务人违反主合同的其他约定，甲方应在保证范围内承担保证责任。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">
            如果甲方未在乙方要求的期限内全部支付应付款项，应自逾期之日起至甲方向乙方支付全部应付款项之日止，根据迟延付款金额按每日万分之
            <input
              style="width: 50px"
              v-model="info.a19"
              type="text"
            >
            的标准向乙方支付违约金。在此情形下，甲方承担的保证责任与上述违约金之和不以本合同约定的最高责任限额为限。
          </span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >二、无论乙方对主合同项下的债权是否拥有其他担保（包括但不限于保证、抵押、质押、保函、备用信用证等担保方式），不论上述其他担保何时成立、是否有效、乙方是否向其他担保人提出权利主张，也不论是否有第三方同意承担主合同项下的全部或部分债务，也不论其他担保是否由债务人自己所提供，甲方在本合同项下的保证责任均不因此减免，乙方均可直接要求甲方依照本合同约定在其保证范围内承担保证责任，甲方将不提出任何异议。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >三、如果本合同约定的保证责任最高限额低于主合同项下实际发生的债权余额，在甲方承担保证责任后主合同项下的债权仍未获完全清偿，则甲方承诺，其向债务人或其他担保人主张（包括预先行使）代位权或追偿权，不应使乙方利益受到任何损害，并同意主合同项下债务的清偿优先于甲方代位权或追偿权的实现。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >（一）甲方同意不向债务人或其他担保人主张代位权或追偿权；如因任何原因，甲方实现了上述权利，则应将所获款项优先用于清偿乙方尚未获偿的债权；</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >（二）主合同项下的债务如有物的担保，甲方同意不以行使代位权为由或任何其他原因对该担保物或其处分后所得价款提出权利主张，上述担保物及所得价款应优先用于清偿乙方尚未获偿的债权；</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >（三）若债务人或其他担保人为甲方提供了反担保，则甲方基于上述反担保而获得的款项应优先用于清偿乙方尚未获偿的债权。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >四、甲方已充分认识到利率风险。如果乙方根据主合同的约定或者国家的利率政策变化而调整利率水平、计息或结息方式，导致债务人应偿还的利息、罚息、复利增加的，对增加部分，甲方也承担连带保证责任。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">一、甲方应对债务人借款使用情况（包括用途）进行监督。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">二、</span>
          <span style="font-family:宋体; font-size:12pt">甲方应接受乙方对其财务状况的监督和检查，</span>
          <span style="font-family:宋体; font-size:12pt">应如实向乙方提供其财产情况</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >和个人信用等有关资料，并保证上述资料的准确、真实、完整与有效性；未经乙方书面同意，甲方不得向第三方提供超出其自身负担能力的担保。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >三、甲方发生国籍变更、住所地变更、婚姻情况变动、重大疾病、受到行政或刑事处罚、涉及重大民事法律纠纷、财务状况恶化，或者因任何原因丧失或可能丧失担保能力，应立即书面通知乙方，并按照乙方要求落实本合同项下保证责任的承担、转移或承继，或者为主合同的履行提供令乙方满意的新担保。如甲方未依据上述约定将其变更后住所地告知乙方，乙方依其合同载明通讯地址向其送达相关文书，即视为乙方已有效送达。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >四、甲方作为控股股东或实际控制人的企业发生合并、分立、股权变动、增减资本、合资、联营等情形，应当在发生上述情形后</span>
          <input style="width: 150px" v-model="info.a20" type="text">
          <span style="font-family:宋体; font-size:12pt">个工作日内书面通知乙方，并附相关材料。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">一、甲方信息的使用</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">二、公告催收</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">三、乙方记录的证据效力</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        >
          ...
          <span style="font-family:宋体; font-size:12pt">权利保留</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">五、债务人解散或破产</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >六、甲方的通讯地址或联系方式如发生变动，应立即书面通知乙方，因未及时通知而造成的损失由甲方自行承担。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">七、 争议解决方式</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">八、 合同生效条件</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">本合同经甲方或授权代理人签字及乙方负责人或授权代理人签字并加盖公章后生效。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">九、 本合同一式</span>
          <input style="width: 50px" v-model="info.a21" type="text">
          <span style="font-family:宋体; font-size:12pt">份</span>
          <span style="font-family:宋体; font-size:12pt">，每份具有同等法律效力</span>
          <span style="font-family:宋体; font-size:12pt">。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">十、 其他约定事项：</span>
        </p>
        <textarea name id cols="30" rows="1" style="text-indent: 2em" v-model="info.a22"></textarea>
        <p style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; widows:0"></p>
        <p style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; widows:0"></p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span style="font-family:宋体; font-size:12pt">三、甲方具备担当保证人的合法资格。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
          <span
            style="font-family:宋体; font-size:12pt"
          >四、甲方确认自己对债务人的资产、债务、经营、信用、信誉等情况、是否具备签订主合同的主体资格和权限以及主合同的所有内容已经充分了解。</span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; text-indent:23.6pt; widows:0"
        >
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; widows:0">
          ...
          <input style="width: 250px;" v-model="info.a29" type="text">
          <span style="font-family:宋体; font-size:12pt"></span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt; orphans:0; widows:0">
          <span style="font-family:宋体; font-size:12pt">签约时间：</span>
        ...
        <p style="margin:0pt; orphans:0; text-indent:23.6pt; widows:0">
        ...
        <p style="margin:0pt; orphans:0; text-indent:20.55pt; widows:0">
          <span style="font-family:'Times New Roman'; font-size:12pt"></span>
        </p>
        <p style="margin:0pt; orphans:0; text-indent:20.55pt; widows:0">
          <span style="font-family:'Times New Roman'; font-size:12pt"></span>
      ...
      <div>
        ...
        <p style="line-height:24pt; margin:0pt; orphans:0; text-indent:20pt; widows:0">
          <span style="font-family:宋体; font-size:12pt">
            二、
            <input v-model="info.a40" type="checkbox">本人（本公司）是借款人：如未按时足额偿还贷款本金、支付利息的，自愿承担贵司因诉讼保全或诉前保全向担保公司交纳的保全担保费用。
          </span>
        </p>
        <p style="line-height:24pt; margin:0pt; orphans:0; text-indent:47pt; widows:0">
          <span style="font-family:宋体; font-size:12pt">
            <input v-model="info.a41" type="checkbox">本人（本公司）是保证人或抵押人或出质人：担保范围除合同约定之外，还包括贵司因诉讼保全或诉前保全向担保公司交纳的保全担保费用。
          </span>
        </p>
        <p style="line-height:24pt; margin:0pt; orphans:0; text-indent:20pt; widows:0">
          <span style="font-family:宋体; font-size:12pt">&nbsp;</span>
  ...
  watch: {
    ...
    "info.a36": {
      handler(nv, ov) {
        ...
        if (nv.length >= 20) {
          this.$nextTick(() => {
            this.$refs.a36textarea.focus();
          });
        } else {
          this.$nextTick(() => {
            this.$refs.a36input.focus();
          });
        }
      }
    },
