    ...
    <div class="contract-content">
      <div style="height: 1080px;">
        ...
        <p style="line-height:16pt; margin:5pt 0pt; text-align:center">
          <span style="font-family:宋体; font-size:16pt; font-weight:bold">（适用于个人授信）</span>
        </p>
        <p style="font-size:14pt; line-height:150%; margin:0pt; orphans:0;    widows:0">
          <span style="font-family:宋体; font-size:14pt">&nbsp;</span>
        </p>
      ...
      <div>
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          ...
          <input style="width: 100px" v-model="info.a38" type="text">
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">
            第3条 本合同项下授信额度的有效使用期间为
            <input style="width: 50px" v-model="info.a10" type="text">年，自
            <input style="width: 50px" v-model="info.a11" type="text">年
            <input style="width: 50px" v-model="info.a12" type="text">月
            <input style="width: 50px" v-model="info.a13" type="text">日至
            <input style="width: 50px" v-model="info.a14" type="text">年
            <input style="width: 50px" v-model="info.a15" type="text">月
            <input style="width: 50px" v-model="info.a16" type="text">日，但贷款额度的具体使用期限应受相关具体借款合同的约定。
          </span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第</span>
          <span style="font-family:宋体; font-size:12pt">9</span>
          <span style="font-family:宋体; font-size:12pt">条 对于授信资金的使用，应符合法律的规定和合同或协议的约定。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第1</span>
          <span style="font-family:宋体; font-size:12pt">0</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >条 在授信期间内，甲方发生国籍变更、住所地变更、婚姻情况变动、重大疾病、受到行政或刑事处罚、涉及重大民事法律纠纷、财务状况恶化，或者因任何原因丧失或可能丧失还款能力，应立即书面通知乙方，并按照乙方要求落实本合同项下的还款义务。如甲方未依据上述约定将其变更后住所地告知乙方，乙方依其合同载明通讯地址向其送达相关文书，即视为乙方已有效送达。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第11</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >条 甲方作为控股股东或实际控制人的企业发生合并、分立、股权变动、增减资本、合资、联营等情形，应当在发生上述情形后十五个工作日内书面通知乙方，并附相关材料。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第12</span>
          <span style="font-family:宋体; font-size:12pt">条 依约偿还授信资金的本息。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt; text-align:center">
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第</span>
          <span style="font-family:宋体; font-size:12pt">13</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >条 如果甲方申请使用授信额度符合国家法律法规、政策规定和乙方的信贷规则，乙方应批准申请并按所签的合同或协议及时履行相应义务。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第</span>
          <span style="font-family:宋体; font-size:12pt">14</span>
          <span style="font-family:宋体; font-size:12pt">条 除有本合同第六章约定情形外，乙方不得随意对授信期间和最高授信额度作出不利于甲方的调整。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第</span>
          <span style="font-family:宋体; font-size:12pt">15</span>
          <span
            style="font-family:宋体; font-size:12pt"
          >条 对甲方在本协议及具体协议项下的到期未付应付款项，乙方有权从甲方在各类金融机构开立的任何账户中扣款以实现债权，上述扣款行为无须事先征得甲方的同意；乙方有权随时检查甲方资金使用情况。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt; text-align:center">
        ...
        >
          <span style="font-family:宋体; font-size:12pt">
            <input v-model="info.a17" type="checkbox">
          </span>
          <input style="width: 200px" v-model="info.a39" type="text">
          <span style="font-family:宋体; font-size:12pt; text-decoration:underline"></span>
          <span style="font-family:宋体; font-size:12pt">
            与乙方签订编号为
            <input style="width: 200px" v-model="info.a18" type="text">《最高额保证合同》；
          </span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt 0pt 0pt 29.35pt; padding-left:16.5pt;  text-indent:-16.5pt"
        >
          <span style="font-family:宋体; font-size:12pt">
            <input v-model="info.a19" type="checkbox">
          </span>
          <input style="width: 200px" v-model="info.a40" type="text">
          <span style="font-family:宋体; font-size:12pt; text-decoration:underline"></span>
          <span style="font-family:宋体; font-size:12pt">
            与乙方签订编号为
            <input style="width: 200px" v-model="info.a20" type="text">《最高额保证合同（适用于个人保证）》；
          </span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt 0pt 0pt 29.35pt; padding-left:16.5pt;  text-indent:-16.5pt"
        >
          <span style="font-family:宋体; font-size:12pt">
            <input v-model="info.a21" type="checkbox">
          </span>
          <input style="width: 200px" v-model="info.a41" type="text">
          <span style="font-family:宋体; font-size:12pt; text-decoration:underline"></span>
          <span style="font-family:宋体; font-size:12pt">
            与乙方签订编号为
            <input style="width: 200px" v-model="info.a22" type="text">《最高额抵押合同》；
          </span>
        </p>
        <p
          style="font-size:12pt; line-height:150%; margin:0pt 0pt 0pt 29.35pt; padding-left:16.5pt;  text-indent:-16.5pt"
        >
          <span style="font-family:宋体; font-size:12pt">
            <input v-model="info.a23" type="checkbox">
          </span>
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          <span
            style="font-family:宋体; font-size:12pt"
          >第19条 本合同经甲方或授权代理人签字及乙方负责人或授权代理人签字并加盖公章后生效。本合同生效后，甲、乙双方任何一方不得擅自变更或提前解除本合同。需要变更或解除时，应经双方协商一致，并达成书面协议。</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:0pt; text-align:center">
          <span style="font-family:宋体; font-size:12pt">第九章 争议和解决</span>
        </p>
        <p style="font-size:12pt; line-height:150%; margin:5pt 0pt; text-indent:22pt">
          <span style="font-family:宋体; font-size:12pt">第20条</span>
          <a name="_Hlk2596345">
            <span style="font-family:宋体; font-size:12pt">本合同在履行过程中发生争议，可以通过协商解决，协商不成，任一方均可向</span>
            <span style="font-family:宋体; font-size:12pt">乙方</span>
        ...
        <p style="font-size:12pt; line-height:150%; margin:0pt;  text-indent:22pt">
          ...
          <textarea name id cols="30" rows="1" style="text-indent: 22pt" v-model="info.a28">各方均同意赋予本合同强制执行效力。本合同解决争议的方式发生冲突时，约定赋予本合同强制执行效力的解决方式优先适用。</textarea>
        </p>
