...
import ensurePersonal from "@/components/contract/ensure-personal.vue"; // 最高额保证合同(个人)
...
import ensureBusiness from "@/components/contract/ensure-business.vue"; // 最高额保证合同(企业)
